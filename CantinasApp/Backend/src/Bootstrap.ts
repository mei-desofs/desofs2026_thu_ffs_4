...
export default async function bootstrap() {
  ...
  try {
    ...
    for (const avgRes of average_reservationsToInsert) {
      const exists = await AverageReservation.findOne({
        where: {
          dishId: avgRes.dishId,
          typeOfMealId: avgRes.typeOfMealId,
          canteenId: avgRes.canteenId,
        },
      });
      if (!exists) {
    ...
    const recipesToInsert = [
      // --- PRATOS DE CARNE ---
      {
        ...
        description:
          "Tempere o frango com sal, pimenta e azeite. Asse no forno junto com batata e cenoura cortadas em pedaços até dourar. Sirva quente.",
      },
      {
        ingredients: [5, 6, 7, 8], // Carne de Vaca Estufada com Tomate e Curgete
        description:
          "Refogue a cebola e a carne de vaca até dourar. Adicione tomate e curgete picados, cozinhe em lume brando até a carne ficar tenra.",
      },
      {
        ingredients: [9, 10, 11], // Peru Grelhado com Arroz e Brócolos
        description:
          "Grelhe o peru temperado com sal e pimenta. Cozinhe o arroz e os brócolos em água a ferver. Sirva o peru com o arroz e os brócolos.",
      },
      {
        ingredients: [12, 13, 8], // Carne de Porco com Abóbora e Cebola
        description:
          "Refogue a cebola, adicione a carne de porco e cozinhe até dourar. Acrescente a abóbora em cubos e cozinhe até ficar macia.",
      },
      {
        ingredients: [14, 15, 2], // Pato Salteado com Maçã e Batata
        description:
          "Salteie o pato em azeite até dourar. Adicione maçã e batata em cubos e cozinhe até a batata ficar macia. Sirva quente.",
      },
      ...
      // --- PRATOS DE PEIXE ---
      {
        ...
        description:
          "Desfie o bacalhau e refogue com cebola e batata palha. Junte os ovos batidos e cozinhe até firmar. Sirva quente.",
      },
      {
        ingredients: [18, 6, 19], // Salmão no Forno com Tomate e Alface
        description:
          "Coloque o salmão temperado num tabuleiro, adicione tomate fatiado e asse até ficar cozido. Sirva com alface fresca.",
      },
      {
        ingredients: [20, 10, 7, 21], // Arroz de Atum
        description:
          "Refogue cebola e tomate, adicione arroz e atum. Cozinhe até o arroz absorver a água e ficar macio.",
      },
      {
        ingredients: [22, 23, 24, 25], // Filetes de Dourada com Puré de Abóbora
        description:
          "Grelhe os filetes de dourada temperados. Cozinhe a abóbora e batata, bata com leite até formar puré. Sirva junto com o peixe.",
      },
      {
        ingredients: [26, 5, 28, 21], // Lulas Estufadas com Cenoura e Cebola
        description:
          "Refogue cebola e cenoura, adicione as lulas e cozinhe em lume brando com tomate até ficarem macias.",
      },
      ...
      // --- PRATOS VEGETARIANOS ---
      {
        ...
        description:
          "Cozinhe a massa. Salteie os legumes até ficarem macios. Misture com a massa cozida e sirva quente.",
      },
      {
        ingredients: [30, 31, 8], // Grão-de-bico com Abóbora e Cebola
        description:
          "Refogue a cebola, adicione o grão-de-bico e a abóbora em cubos. Cozinhe até a abóbora ficar macia. Tempere a gosto.",
      },
      {
        ingredients: [32, 5, 33, 28, 28], // Feijoada Vegetariana
        description:
          "Refogue cebola, adicione feijão, tomate, cenoura e abóbora. Cozinhe até os legumes ficarem macios e sirva.",
      },
      {
        ingredients: [34, 35, 15, 36], // Salada de Alface com Pera, Maçã e Curgete
        description:
          "Misture alface, pera, maçã e curgete cortados em tiras. Tempere a gosto e sirva fria.",
      },
      {
        ingredients: [37, 28, 38], // Sopa de Tomate com Cebola e Batata
        description:
          "Refogue cebola e tomate, adicione batata e cozinhe até os legumes ficarem macios. Triture para formar uma sopa cremosa e sirva.",
      },
    ];
    ...
    const additionalProductsToInsert = [
      ...
      },
      {
        ...
        typeId: 2,
        nutrition: [
          { typeId: 1, percentage: 2.9 },
          { typeId: 2, percentage: 3.6 },
          { typeId: 4, percentage: 23 },
        ],
        allergens: [],
      },
      {
      ...
      },
      {
        ...
        typeId: 2,
        nutrition: [
          { typeId: 1, percentage: 5 },
          { typeId: 2, percentage: 14 },
          { typeId: 4, percentage: 81 },
        ],
        allergens: [],
      },
      {
      ...
      },
      {
        ...
        typeId: 2,
        nutrition: [
          { typeId: 1, percentage: 3.1 },
          { typeId: 2, percentage: 3.3 },
          { typeId: 4, percentage: 22 },
        ],
        allergens: [],
      },
      {
        ...
        typeId: 2,
        nutrition: [
          { typeId: 1, percentage: 3.3 },
          { typeId: 2, percentage: 19 },
          { typeId: 4, percentage: 86 },
        ],
        allergens: [],
      },
      {
      ...
      },
      {
        ...
        typeId: 5,
        nutrition: [
          { typeId: 1, percentage: 18 },
          { typeId: 2, percentage: 15 },
          { typeId: 4, percentage: 200 },
        ],
        allergens: [7],
      },
      {
      ...
      },
      {
        ...
        typeId: 5,
        nutrition: [
          { typeId: 1, percentage: 12 },
          { typeId: 2, percentage: 2 },
          { typeId: 4, percentage: 50 },
        ],
        allergens: [7],
      },
      {
        ...
        typeId: 6,
        nutrition: [
          { typeId: 1, percentage: 14 },
          { typeId: 2, percentage: 64 },
          { typeId: 4, percentage: 120 },
        ],
        allergens: [],
      },
      {
        ...
        nutrition: [
          { typeId: 1, percentage: 13 },
          { typeId: 2, percentage: 77 },
          { typeId: 4, percentage: 112 },
        ],
        allergens: [],
      },
      {
        ...
        typeId: 6,
        nutrition: [
          { typeId: 1, percentage: 36 },
          { typeId: 2, percentage: 40 },
          { typeId: 4, percentage: 371 },
        ],
        allergens: [2],
      },
      {
        ...
        typeId: 6,
        nutrition: [
          { typeId: 1, percentage: 8 },
          { typeId: 3, percentage: 5 },
          { typeId: 4, percentage: 70 },
        ],
        allergens: [],
      },
      {
      ...
      },
      {
        ...
        nutrition: [
          { typeId: 1, percentage: 21 },
          { typeId: 3, percentage: 8 },
          { typeId: 4, percentage: 173 },
        ],
        allergens: [],
      },
      {
        ...
        typeId: 4,
        nutrition: [
          { typeId: 1, percentage: 24 },
          { typeId: 3, percentage: 7 },
          { typeId: 4, percentage: 181 },
        ],
        allergens: [],
      },
      {
        ...
        nutrition: [
          { typeId: 1, percentage: 25 },
          { typeId: 3, percentage: 12 },
          { typeId: 4, percentage: 192 },
        ],
        allergens: [],
      },
      {
      ...
      },
      {
        ...
        typeId: 3,
        nutrition: [
          { typeId: 1, percentage: 3.5 },
          { typeId: 2, percentage: 4 },
          { typeId: 3, percentage: 1 },
          { typeId: 4, percentage: 61 },
        ],
        allergens: [1],
      },
      {
      ...
      },
      {
        ...
        typeId: 3,
        nutrition: [
          { typeId: 1, percentage: 11 },
          { typeId: 3, percentage: 13 },
          { typeId: 4, percentage: 174 },
        ],
        allergens: [1],
      },
      {
        ...
        typeId: 6,
        nutrition: [
          { typeId: 3, percentage: 81 },
          { typeId: 4, percentage: 717 },
        ],
        allergens: [1],
      },
      {
        ...
        nutrition: [
          { typeId: 1, percentage: 11 },
          { typeId: 2, percentage: 65 },
          { typeId: 3, percentage: 10 },
          { typeId: 4, percentage: 390 },
        ],
        allergens: [],
      },
      {
        ...
        typeId: 6,
        nutrition: [
          { typeId: 1, percentage: 30 },
          { typeId: 3, percentage: 49 },
          { typeId: 4, percentage: 559 },
        ],
        allergens: [],
      },
      {
        ...
        typeId: 6,
        nutrition: [
          { typeId: 1, percentage: 15 },
          { typeId: 3, percentage: 65 },
          { typeId: 4, percentage: 654 },
        ],
        allergens: [5],
      },
      {
        ...
        nutrition: [
          { typeId: 1, percentage: 21 },
          { typeId: 3, percentage: 50 },
          { typeId: 4, percentage: 579 },
        ],
        allergens: [5],
      },
    ];
    ...
    const additionalRecipesToInsert = [
      // PRATOS DE CARNE ADICIONAIS (16-25) -> IDs 47-61
      {
        ...
        description:
          "Estufe o coelho com ervas aromáticas. Cozinhe a quinoa e salteie cogumelos. Sirva tudo juntos.",
      },
      {
        ingredients: [53, 48, 40], // Faisão com Cuscuz e Espinafres id 17
        description:
          "Grelhe o faisão temperado. Prepare o cuscuz e refogue os espinafres. Monte no prato.",
      },
      {
        ingredients: [54, 42, 3], // Codorniz Assada com Ervilhas e Cenoura id 18
        description:
          "Asse as codornizes no forno. Cozinhe ervilhas e cenoura em azeite. Sirva com molho do assado.",
      },
      {
        ingredients: [55, 2, 57], // Cordeiro no Forno com Batata Doce (usando Batata normal) id 19
        description:
          "Tempere o cordeiro com alecrim e alho. Asse com batata até dourar. Sirva com iogurte natural.",
      },
      {
        ingredients: [56, 41, 59], // Vitela Grelhada com Puré de Couve-flor id 20
        description:
          "Grelhe a vitela. Cozinhe couve-flor e bata com queijo ricotta até obter um puré cremoso.",
      },
      {
        ingredients: [12, 61, 45], // Carne de Porco com Açafrão e Milho id 21
        description:
          "Marine a carne de porco com açafrão. Grelhe e sirva com milho cozido e sementes de abóbora.",
      },
      {
        ingredients: [1, 64, 10], // Frango com Amêndoas e Arroz id 22
        description:
          "Salteie frango com amêndoas laminadas. Sirva com arroz basmati e brócolos salteados.",
      },
      {
        ingredients: [5, 39, 40], // Carne de Vaca com Couve Portuguesa e Espinafres id 23
        description:
          "Cozinhe a carne de vaca com couve portuguesa e espinafres em estufado lento até ficar tenra.",
      },
      {
        ingredients: [9, 41, 42], // Peru com Couve-flor e Ervilhas id 24
        description:
          "Grelhe peitos de peru. Sirva com couve-flor gratinada e ervilhas refogadas.",
      },
      {
        ingredients: [14, 43, 8], // Pato com Pimento e Cebola id 25
        description:
          "Confite pato e sirva com pimentos coloridos salteados e cebola roxa.",
      },
      ...
      },
      {
        ...
        description:
          "Estufe carne de vaca com cebola e sirva com iogurte natural e batata.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Salteie carne de porco com lulas e sirva com batata frita.",
      },
      {
        ingredients: [1, 5, 39], // Cozido à Portuguesa (simplificado) - usando Couve Portuguesa id 30
        description:
          "Cozinhe frango, carne de vaca e porco com batata, cenoura e couve.",
      },
      ...
      // PRATOS DE PEIXE ADICIONAIS (16-25) -> IDs 62-76
      {
        ...
        description:
          "Asse bacalhau com rodelas de beringela e tomate cherry. Regue com azeite e orégãos.",
      },
      {
        ingredients: [18, 44, 40], // Salmão com Cogumelos e Espinafres id 32
        description:
          "Grelhe salmão e sirva com cogumelos salteados e espinafres frescos.",
      },
      {
        ingredients: [20, 47, 4], // Atum com Quinoa e Banana (substituindo abacate) id 33
        description:
          "Grelhe atum raro. Sirva com quinoa e banana temperada com limão.",
      },
      {
        ingredients: [22, 49, 40], // Dourada com Tremoços e Espinafres id 34
        description:
          "Asse dourada no forno. Sirva com tremoços cozidos e espinafres salteados.",
      },
      {
        ingredients: [26, 50, 43], // Lulas com Tofu e Pimentos id 35
        description:
          "Salteie lulas com tofu e pimentos variados. Tempere com molho de soja e gengibre.",
      },
      {
        ingredients: [39, 48, 43], // Camarão Grelhado com Cuscuz e Pimento id 36
        description:
          "Grelhe camarões temperados com alho. Sirva com cuscuz e pimentos grelhados.",
      },
      {
        ingredients: [40, 8, 29], // Amêijoas à Bulhão Pato id 37
        description:
          "Cozinhe amêijoas com alho, coentros e vinho branco. Sirva com pão caseiro.",
      },
      {
        ingredients: [16, 30, 40], // Bacalhau com Grão e Espinafres id 38
        description:
          "Cozinhe bacalhau desfiado com grão-de-bico e espinafres. Sirva com azeite.",
      },
      {
        ingredients: [18, 47, 57], // Salmão com Quinoa e Iogurte id 39
        description:
          "Asse salmão e sirva com quinoa cozida e molho de iogurte com endro.",
      },
      {
        ingredients: [26, 46, 43], // Lulas Recheadas com Pimento id 40
        description:
          "Recheie lulas com pimento e cebola picados. Asse no forno com molho de tomate.",
      },
      ...
      },
      {
        ...
        description:
          "Asse salmão no forno com tomate e sirva com batata cozida.",
      },
      {
      ...
      // PRATOS VEGETARIANOS ADICIONAIS (16-25) -> IDs 77-91
      {
        ...
        description:
          "Cozinhe quinoa e salteie com cenoura e pimento. Tempere com ervas frescas.",
      },
      {
        ingredients: [48, 50, 43], // Cuscuz com Tofu e Pimentos id 47
        description:
          "Prepare cuscuz e sirva com tofu grelhado e pimentos assados.",
      },
      {
        ingredients: [49, 31, 34], // Tremoços com Salada de Feijão id 48
        description:
          "Misture tremoços com feijão, cebola roxa e salsa. Tempere com vinagrete.",
      },
      {
        ingredients: [50, 11, 47], // Tofu Grelhado com Arroz Integral id 49
        description:
          "Marine tofu e grelhe. Sirva com arroz integral e brócolos no vapor.",
      },
      {
        ingredients: [51, 8, 3], // Seitan Estufado com Cebola e Cenoura id 50
        description:
          "Estufe seitan com cebola, cenoura e molho de soja. Sirva com arroz basmati.",
      },
      {
        ingredients: [39, 30, 2], // Sopa de Couve com Grão id 51
        description:
          "Cozinhe couve portuguesa com grão-de-bico. Triture para obter sopa cremosa.",
      },
      {
        ingredients: [40, 41, 58], // Espinafres com Gratinado de Couve-flor id 52
        description:
          "Refogue espinafres e cubra com couve-flor. Gratine no forno com queijo.",
      },
      {
        ingredients: [46, 7, 6], // Ratatouille Provençal id 53
        description:
          "Cozinhe beringela, curgete, pimento e tomate em camadas. Asse no forno.",
      },
      {
        ingredients: [44, 58, 29], // Cogumelos Recheados com Queijo id 54
        description:
          "Recheie cogumelos com queijo e alho. Asse até derreter o queijo.",
      },
      {
        ingredients: [47, 63, 43], // Salada de Quinoa com Nozes e Pimento id 55
        description:
          "Misture quinoa cozida com nozes, passas e pimento. Tempere com limão.",
      },
      // Mais 5 pratos vegetarianos para completar 25
      {
        ingredients: [29, 40, 41], // Lasanha de Vegetais id 56
        description:
          "Faça camadas de massa, espinafres e couve-flor com molho bechamel.",
      },
      {
        ingredients: [30, 2, 58], // Hambúrguer de Grão id 57
        description:
          "Moa grão com batata e forme hambúrgueres. Grelhe e sirva com queijo.",
      },
      {
        ingredients: [50, 2, 41], // Empadão de Tofu id 58
        description:
          "Faça recheio de tofu com legumes e cubra com puré de batata.",
      },
      {
    ...
    const aditionalDishes = [
      ...
      {
        dishTypeId: 1,
        name: "Coelho Estufado com Quinoa e Cogumelos",
        recipeId: 16,
        mainProductsId: [46, 41, 35],
      }, // Coelho (46), Quinoa (41), Cogumelos (35)
      {
        dishTypeId: 1,
        name: "Faisão com Cuscuz e Espinafres",
        recipeId: 17,
        mainProductsId: [47, 42, 31],
      }, // Faisão (47), Cuscuz (42), Espinafres (31)
      {
        dishTypeId: 1,
        name: "Codorniz Assada com Ervilhas e Cenoura",
        recipeId: 18,
        mainProductsId: [48, 33, 5],
      }, // Codorniz (48), Ervilhas (33), Cenoura (5)
      {
        dishTypeId: 1,
        name: "Cordeiro no Forno com Batata",
        recipeId: 19,
        mainProductsId: [49, 11, 51],
      }, // Cordeiro (49), Batata (11), Iogurte (51)
      {
        dishTypeId: 1,
        name: "Vitela com Puré de Couve-flor",
        recipeId: 20,
        mainProductsId: [50, 32, 53],
      }, // Vitela (50), Couve-flor (32), Ricotta (53)
      {
        dishTypeId: 1,
        name: "Carne de Porco com Açafrão e Milho",
        recipeId: 21,
        mainProductsId: [13, 55, 36],
      }, // Porco (13), Açafrão (55), Milho (36)
      {
        dishTypeId: 1,
        name: "Frango com Amêndoas",
        recipeId: 22,
        mainProductsId: [6, 58, 16],
      }, // Frango (6), Amêndoas (58), Arroz (16)
      {
        dishTypeId: 1,
        name: "Carne de Vaca com Couve Portuguesa",
        recipeId: 23,
        mainProductsId: [7, 30, 31],
      }, // Vaca (7), Couve Portuguesa (30), Espinafres (31)
      {
        dishTypeId: 1,
        name: "Peru com Couve-flor e Ervilhas",
        recipeId: 24,
        mainProductsId: [17, 32, 33],
      }, // Peru (17), Couve-flor (32), Ervilhas (33)
      {
        dishTypeId: 1,
        name: "Pato com Pimento e Cebola",
        recipeId: 25,
        mainProductsId: [18, 34, 27],
      }, // Pato (18), Pimento (34), Cebola (27)
      {
        dishTypeId: 1,
        name: "Frango com Milho e Arroz",
        recipeId: 26,
        mainProductsId: [6, 36, 16],
      }, // Frango (6), Milho (36), Arroz (16)
      {
        dishTypeId: 1,
        name: "Carne de Vaca ao Molho de Cebola",
        recipeId: 27,
        mainProductsId: [7, 27, 51],
      }, // Vaca (7), Cebola (27), Iogurte (51)
      {
        dishTypeId: 1,
        name: "Peru com Maçã e Batata",
        recipeId: 28,
        mainProductsId: [17, 1, 11],
      }, // Peru (17), Maçã (1), Batata (11)
      {
        dishTypeId: 1,
        name: "Porco à Alentejana",
        recipeId: 29,
        mainProductsId: [13, 21, 11],
      }, // Porco (13), Lulas (21), Batata (11)
      {
        dishTypeId: 1,
        name: "Cozido à Portuguesa",
        recipeId: 30,
        mainProductsId: [6, 7, 30],
      }, // Frango (6), Vaca (7), Couve (30)

      // PRATOS DE PEIXE ADICIONAIS (IDs 16-30) - CORRIGIDO
      {
        dishTypeId: 2,
        name: "Bacalhau com Beringela",
        recipeId: 31,
        mainProductsId: [19, 37, 12],
      }, // Bacalhau (19), Beringela (37), Tomate (12)
      {
        dishTypeId: 2,
        name: "Salmão com Cogumelos e Espinafres",
        recipeId: 32,
        mainProductsId: [14, 35, 31],
      }, // Salmão (14), Cogumelos (35), Espinafres (31)
      {
        dishTypeId: 2,
        name: "Atum com Quinoa e Banana",
        recipeId: 33,
        mainProductsId: [15, 41, 4],
      }, // Atum (15), Quinoa (41), Banana (4)
      {
        dishTypeId: 2,
        name: "Dourada com Tremoços e Espinafres",
        recipeId: 34,
        mainProductsId: [20, 43, 31],
      }, // Dourada (20), Tremoços (43), Espinafres (31)
      {
        dishTypeId: 2,
        name: "Lulas com Tofu e Pimentos",
        recipeId: 35,
        mainProductsId: [21, 44, 34],
      }, // Lulas (21), Tofu (44), Pimento (34)
      {
        dishTypeId: 2,
        name: "Camarão Grelhado com Cuscuz e Pimento",
        recipeId: 36,
        mainProductsId: [39, 42, 34],
      }, // Camarão (39), Cuscuz (42), Pimento (34)
      {
        dishTypeId: 2,
        name: "Amêijoas à Bulhão Pato",
        recipeId: 37,
        mainProductsId: [40, 27, 29],
      }, // Amêijoas (40), Cebola (27), Alho (29)
      {
        dishTypeId: 2,
        name: "Bacalhau com Grão e Espinafres",
        recipeId: 38,
        mainProductsId: [19, 24, 31],
      }, // Bacalhau (19), Grão (24), Espinafres (31)
      {
        dishTypeId: 2,
        name: "Salmão com Quinoa e Iogurte",
        recipeId: 39,
        mainProductsId: [14, 41, 51],
      }, // Salmão (14), Quinoa (41), Iogurte (51)
      {
        dishTypeId: 2,
        name: "Lulas Recheadas com Pimento",
        recipeId: 40,
        mainProductsId: [21, 37, 34],
      }, // Lulas (21), Beringela (37), Pimento (34)
      {
        dishTypeId: 2,
        name: "Polvo à Lagareiro",
        recipeId: 41,
        mainProductsId: [21, 11, 29],
      }, // Lulas (21), Batata (11), Alho (29)
      {
        dishTypeId: 2,
        name: "Sardinhas Assadas",
        recipeId: 42,
        mainProductsId: [14, 12, 11],
      }, // Salmão (14), Tomate (12), Batata (11)
      {
        dishTypeId: 2,
        name: "Pescada Cozida",
        recipeId: 43,
        mainProductsId: [20, 5, 27],
      }, // Dourada (20), Cenoura (5), Cebola (27)
      {
        dishTypeId: 2,
        name: "Caldeirada de Peixe",
        recipeId: 44,
        mainProductsId: [19, 15, 14],
      }, // Bacalhau (19), Atum (15), Salmão (14)
      {
        dishTypeId: 2,
        name: "Peixe Espada com Cogumelos",
        recipeId: 45,
        mainProductsId: [20, 35, 12],
      }, // Dourada (20), Cogumelos (35), Tomate (12)

      // PRATOS VEGETARIANOS ADICIONAIS (IDs 16-30) - CORRIGIDO
      {
        dishTypeId: 3,
        name: "Quinoa com Cenoura e Pimento",
        recipeId: 46,
        mainProductsId: [41, 5, 34],
      }, // Quinoa (41), Cenoura (5), Pimento (34)
      {
        dishTypeId: 3,
        name: "Cuscuz com Tofu e Pimentos",
        recipeId: 47,
        mainProductsId: [42, 44, 34],
      }, // Cuscuz (42), Tofu (44), Pimento (34)
      {
        dishTypeId: 3,
        name: "Salada de Tremoços com Feijão",
        recipeId: 48,
        mainProductsId: [43, 22, 26],
      }, // Tremoços (43), Feijão (22), Alface (26)
      {
        dishTypeId: 3,
        name: "Tofu Grelhado com Brócolos",
        recipeId: 49,
        mainProductsId: [44, 10, 41],
      }, // Tofu (44), Brócolos (10), Quinoa (41)
      {
        dishTypeId: 3,
        name: "Seitan Estufado com Cebola e Cenoura",
        recipeId: 50,
        mainProductsId: [45, 27, 5],
      }, // Seitan (45), Cebola (27), Cenoura (5)
      {
        dishTypeId: 3,
        name: "Sopa de Couve com Grão",
        recipeId: 51,
        mainProductsId: [30, 24, 11],
      }, // Couve (30), Grão (24), Batata (11)
      {
        dishTypeId: 3,
        name: "Espinafres Gratinados",
        recipeId: 52,
        mainProductsId: [31, 32, 52],
      }, // Espinafres (31), Couve-flor (32), Queijo (52)
      {
        dishTypeId: 3,
        name: "Ratatouille",
        recipeId: 53,
        mainProductsId: [37, 9, 12],
      }, // Beringela (37), Curgete (9), Tomate (12)
      {
        dishTypeId: 3,
        name: "Cogumelos Recheados",
        recipeId: 54,
        mainProductsId: [35, 52, 29],
      }, // Cogumelos (35), Queijo (52), Alho (29)
      {
        dishTypeId: 3,
        name: "Salada de Quinoa com Nozes",
        recipeId: 55,
        mainProductsId: [41, 57, 34],
      }, // Quinoa (41), Nozes (57), Pimento (34)
      {
        dishTypeId: 3,
        name: "Lasanha de Vegetais",
        recipeId: 56,
        mainProductsId: [23, 31, 32],
      }, // Massa (23), Espinafres (31), Couve-flor (32)
      {
        dishTypeId: 3,
        name: "Hambúrguer de Grão",
        recipeId: 57,
        mainProductsId: [24, 11, 52],
      }, // Grão (24), Batata (11), Queijo (52)
      {
        dishTypeId: 3,
        name: "Empadão de Tofu",
        recipeId: 58,
        mainProductsId: [44, 11, 32],
      }, // Tofu (44), Batata (11), Couve-flor (32)
      {
        dishTypeId: 3,
        name: "Curry de Feijão com Milho",
        recipeId: 59,
        mainProductsId: [22, 36, 55],
      }, // Feijão (22), Milho (36), Açafrão (55)
      {
        dishTypeId: 3,
        name: "Pizza Vegetariana",
        recipeId: 60,
        mainProductsId: [23, 35, 52],
      }, // Massa (23), Cogumelos (35), Queijo (52)
    ];
  ...
  const usersToInsert = [
    ...
    {
      name: "RefectoryManager",
      email: "rm@email.com",
      role: "RefectoryManager",
    },
    {
      name: "RefectoryManager2",
      email: "rm2@email.com",
      role: "RefectoryManager",
    },
    {
      name: "RefectoryManager3",
      email: "rm3@email.com",
      role: "RefectoryManager",
    },
  ...
  try {
    ...
    const menuType5Dias = await MenuType.findOne({
      where: { name: "Menu 5 dias" },
    });
    const menuType7Dias = await MenuType.findOne({
      where: { name: "Menu 7 dias" },
    });

    if (!menuType5Dias || !menuType7Dias) {
      console.log(
        "⚠️ MenuTypes não encontrados. Certifica-te de que foram criados primeiro.",
      );
    } else {
      // 1. Criar Instituição 1 - Escola
      let institution1 = await Institution.findOne({
        where: { name: "Escola Primária Central de Cinfães" },
      });
      if (!institution1) {
      ...
      let institution2 = await Institution.findOne({
        where: { name: "Lar de Idosos São João de Cinfães" },
      });
      if (!institution2) {
      ...
      let institution3 = await Institution.findOne({
        where: { name: "Lar de Idosos Santa Maria de Cinfães" },
      });
      if (!institution3) {
      ...
      let canteen1 = await Canteen.findOne({
        where: { name: "Cantina da Escola Central de Cinfães" },
      });
      ...
      let refeitorio1 = await Refeitorio.findOne({
        where: { name: "Refeitório da Escola Central de Cinfães" },
      });
      ...
      let canteen2 = await Canteen.findOne({
        where: { name: "Cantina do Lar São João de Cinfães" },
      });
      ...
      let refeitorio2 = await Refeitorio.findOne({
        where: { name: "Refeitório do Lar São João de Cinfães" },
      });
      ...
      let refeitorio3 = await Refeitorio.findOne({
        where: { name: "Refeitório do Lar Santa Maria de Cinfães" },
      });
      ...
      if (canteen1 && refeitorio1 && refeitorio3) {
        ...
        console.log(
          "✅ Cantina da Escola associada com Refeitório da Escola e Lar 2",
        );
      }
      ...
      const refeitorio1ForUsers = await Refeitorio.findOne({
        where: { name: "Refeitório da Escola Central de Cinfães" },
      });
      const refeitorio2ForUsers = await Refeitorio.findOne({
        where: { name: "Refeitório do Lar São João de Cinfães" },
      });

      // Associar RefectoryStaff ao primeiro refeitório
      if (refeitorio1ForUsers) {
        const refectoryStaff = await User.findOne({
          where: { email: "rstaff@email.com" },
        });
        ...
        const rstaff2 = await User.findOne({
          where: { email: "rstaff2@email.com" },
        });
        if (rstaff2 && !rstaff2.refeitorioId) {
          ...
          await rstaff2.save();
          console.log(
            "✅ RefectoryStaff2 associado ao Refeitório da Escola (ID 1)",
          );
        }

        const rstaff3 = await User.findOne({
          where: { email: "rstaff3@email.com" },
        });
        if (rstaff3 && !rstaff3.refeitorioId) {
          ...
          await rstaff3.save();
          console.log(
            "✅ RefectoryStaff3 associado ao Refeitório da Escola (ID 1)",
          );
        }
      }
      ...
      if (refeitorio2ForUsers) {
        const refectoryManager = await User.findOne({
      ...
      if (refeitorio1ForUsers) {
        const refectoryManager3 = await User.findOne({
          where: { email: "rm3@email.com" },
        });
        if (refectoryManager3 && !refectoryManager3.refeitorioId) {
          ...
          console.log(
            "✅ RefectoryManager3 associado ao Refeitório da Escola (ID 1)",
          );
        }
      }
      ...
      if (refeitorio1ForUsers) {
        ...
        if (nutritionist && !nutritionist.refeitorioId) {
          ...
          console.log(
            "✅ Nutritionist associado ao Refeitório da Escola (ID 1)",
          );
        }
      }
      ...
      if (refeitorio2ForUsers) {
        const nutritionist2 = await User.findOne({
          where: { email: "nutri2@email.com" },
        });
        if (nutritionist2 && !nutritionist2.refeitorioId) {
          nutritionist2.refeitorioId = refeitorio2ForUsers.id;
          await nutritionist2.save();
          console.log(
            "✅ Nutritionist2 associado ao Refeitório do Lar 1 (ID 2)",
          );
        }
      }
      ...
      if (canteen1ForUsers) {
        const canteenManager = await User.findOne({
          where: { email: "cm@email.com" },
        });
      ...
      const canteen1ForMeals = await Canteen.findOne({
        where: { name: "Cantina da Escola Central de Cinfães" },
      });
      const refeitorio1ForMeals = await Refeitorio.findOne({
        where: { name: "Refeitório da Escola Central de Cinfães" },
      });
      ...
      if (canteen1ForMeals && refeitorio1ForMeals) {
        ...
        const dishNameMap: { [key: string]: string } = {
          ...
          "Carne de Vaca Estufada":
            "Carne de Vaca Estufada com Tomate e Curgete",
        ...
        for (const meal of mealsToInsert) {
          ...
          if (!dishName) {
            console.log(
              `⚠️ Nome de dish não mapeado para a meal "${meal.name}". A meal não foi criada.`,
            );
            continue;
          }
          ...
          if (!dish) {
            console.log(
              `⚠️ Dish "${dishName}" não encontrado. A meal "${meal.name}" não foi criada.`,
            );
            continue;
          }
        ...
        console.log(
          "⚠️ Cantina ou Refeitório não encontrados. Meals não foram criadas.",
        );
      }
    }
  } catch (error) {
    console.error(
      "Error creating institutions/canteens/refeitorios/meals:",
      error,
    );
  }
}
